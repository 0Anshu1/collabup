...
const FeatureCard = ({ icon: Icon, title, description, link, color }: any) => (
  <Link href={link} className="bg-[#1E293B] p-6 rounded-xl transform hover:scale-105 hover:bg-[#2D3B4E] transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/20">
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="bg-[#1E293B] rounded-xl p-8 mb-8 transform hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/20">
        ...
        <div className="flex">
          <Link href="/college-community" className="btn-primary px-4 py-2">
      ...
      <div className="bg-[#1E293B] rounded-xl p-8 mb-8 transform hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/20">
        ...
        <div className="flex">
          <Link href="/research-projects" className="btn-orange px-4 py-2">
